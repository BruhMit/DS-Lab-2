...
void insertNodeAtMiddle(int item, int pos);
void deleteFirstNode();
void deleteLastNode();
void deleteMiddleNode(pos);
void reverseList();
void deleteList();
void displayList();
...
//    createList(n);
        ...
        printf("NAME:Bruh Teshome\t   ID  :MIT/UR/1032/10 \n");
        printf("NAME:Muez Abebe\t\t   ID  :MIT/UR/10101/10  \n");
		printf("NAME:Mengstu Hadush\t   ID  :MIT/UR/1093/10  \n");
        printf("##############################\n");
        printf(" SINGLE-LIST  IMPLEMENTATION OF DATA STRUCTURES PROGRAM  IN C   \n");
    while(1)
    {
        /* Menu */
        printf("###############################\n");
        printf("1. to create and traverse list\n");
        ...
        printf("9. to delete data at the first\n");
